...
from clusterman.autoscaler._private.command_runner import AUTOSCALER_NODE_START_WAIT_S, ProcessRunnerError
...
class NodeUpdater:
    ...
    def do_update(self):
        self.provider.set_node_tags(
            self.node_id, {TAG_NODE_STATUS: STATUS_WAITING_FOR_SSH})
